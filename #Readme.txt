...
4. selectStmts.txt files consist of only sample records selected from each table.
5. SoccerPy folder consist of python script - soccer.py used to load all csv data to database.
